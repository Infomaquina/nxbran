...
export default async function Tabela(){
   ...
   const data = await executeQuery(
      "SELECT DATE_FORMAT(r.data, '%H:%i:%s') AS hora, DATE_FORMAT(r.data, '%d/%m') AS dia, CASE r.momento WHEN 0 THEN 'entrada' WHEN 1 THEN 'intervalo' WHEN 2 THEN 'retorno' WHEN 3 THEN 'saida' END AS result, u.name, u.cor FROM registros r LEFT JOIN users u ON r.id_user = u.id ORDER BY r.id DESC"
   )
